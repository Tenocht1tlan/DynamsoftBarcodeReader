...
typedef NS_ENUM(NSInteger,EnumIntermediateResultSavingMode)
{
    ...
    /**Save intermediate results in file system.*/
    EnumIntermediateResultSavingModeFileSystem  = 0x02,
    
    /**Save intermediate results both in memory and file system.*/
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* colourClusteringModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* colourConversionModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* grayscaleTransformationModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* regionPredetectionModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* imagePreprocessingModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* textureDetectionModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* textFilterModes;
...
* @sa EnumColourConversionMode
*/
@property (nonatomic, readwrite, nonnull) NSArray* dpmCodeReadingModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* deformationResistingModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* barcodeComplementModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* barcodeColourModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* binarizationModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* localizationModes;
...
*/
@property (nonatomic, readwrite, nonnull) NSArray* textResultOrderModes;
...
/**The max count of frames waiting results(text result/localization result) will be kept for further reference.
 *
 * @par Value range:
 *         [0, 0x7fffffff]
 * @par Default value:
...
/**The stride of the frame image(alse called scan width).
 *
 * @par Value range:
 *         [0,0x7fffffff]
 * @par Default value:
...
/**The image pixel format used int the image byte array.
 *
 * @par Value range:
 ...
 *         between current frame and the history frames is larger than the given threshold, the current frame and the history
 *         frames is larger than the given threshold, the current frame will not be added to the inner frame queue waiting for decoding.
 */
...
@property (nonatomic, nonnull) NSArray* resultPoints;
...
* @param userData Arguments pass to your function.
*
* @sa TextResultArray
*
* @par Code Snippet:
...
/**
 * Initialize runtime settings with t _Nullable he settings in given JSON string.
 *
